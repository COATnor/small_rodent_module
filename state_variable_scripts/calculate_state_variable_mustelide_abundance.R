...
for (i in 1:length(years)) {
  ...
  remove_images <- dat_year %>% filter(v_trigger_mode == "motion_sensor", v_class_id == "bad_quality", v_presence == 1) # get motion sensor images with bad quality -> they will be removed
